...
class SpeechDetector:
    def __init__(self):
        ...
        self.SILENCE_LIMIT = 1  # Silence limit in seconds.
        # The max ammount of seconds where
        # only silence is recorded. When this time passes the
        # recording finishes and the file is decoded

        self.PREV_AUDIO = 0.5  # Previous audio (in seconds) to prepend.
        # When noise is detected, how much of previously recorded audio is
        ...
        # These will need to be modified according to where
        # the pocketsphinx folder is
    ...
    def run(self):
        ...
        while True:
            ...
            if sum([x > self.THRESHOLD for x in slid_win]) > 0:
                ...
                # data = b''.join(list(prev_audio) + audio2send)
